...
class product_template(osv.osv):
    ...
    def _get_product_template_type(self, cr, uid, context=None):
        return [('consu', _('Consumable')), ('service', _('Service')), ('sto', _('Stocké')), ('ordi', _('Ordinateur')), ('peri', _('Périphérique')), ('equi', ('Autres équipements Informatiques'))]
    ...
    _columns = {
        ...
        'list_price': fields.float('Sale Price', digits_compute=dp.get_precision('Product Price'), readonly=True, help="Base price to compute the customer price. Sometimes called the catalog price."),
        'lst_price' : fields.related('list_price', type="float", string='Public Price', digits_compute=dp.get_precision('Product Price')),
        'standard_price': fields.function(_compute_product_template_field, fnct_inv=_set_product_template_field, fnct_search=_search_by_standard_price, multi='_compute_product_template_field', type='float', string='Cost', digits_compute=dp.get_precision('Product Price'), readonly=True,
